...
- No ownership rights are transferred to the project.
...
- publish, distribute, and sell your story as part of the compendium;
- distribute via **Amazon Kindle Direct Publishing (KDP)** in ebook and print formats;
- edit, format, and adapt your story for editorial cohesion and platform requirements;
- display excerpts for marketing and promotion.
...
- Final editorial authority rests with the project lead.
...
- Revenue, if any, will be shared as described in project documentation.
...
## 6. No Partnership or Ownership

- You are not a partner, employee, or co-owner of the project.
- Revenue sharing does not confer ownership, control, or decision-making rights.
...
- it does not contain unlawful or defamatory material.

You are responsible for claims arising from your submission.

---

## 8. Platform Disclaimer

- Publication is subject to acceptance by Amazon KDP.
- Platform rejection or delisting does not create liability for the project or project lead.

---

## 9. Token Association

- Any FRWC token association is **symbolic and non-binding**.
- Revenue is paid to the named contributor only, not token holders.
